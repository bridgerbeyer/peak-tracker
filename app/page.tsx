      ...
      <header style={{ background: 'var(--bg)', borderBottom: '1px solid var(--border)', padding: '0 1.5rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 60 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <span style={{ fontSize: 12, color: 'var(--gray)', letterSpacing: '0.04em' }}>Peak Condo Storage</span>
          </div>
      ...
      <div style={{ background: 'var(--surface)', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', padding: '0 1.5rem' }}>
          {([
            ...
            <button key={t.key} onClick={() => setTab(t.key)} style={{ padding: '14px 18px', border: 'none', background: 'none', fontSize: 13, fontWeight: 500, cursor: 'pointer', color: tab === t.key ? 'var(--text)' : 'var(--gray)', borderBottom: tab === t.key ? '2px solid #CC2222' : '2px solid transparent', transition: 'color 0.15s' }}>
              {t.label}
            </button>
          ))}
        </div>
